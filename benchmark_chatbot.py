...
TESTS: List[Dict[str, Any]] = [
    ...
    # ══════════════════════════════════════════════════════════════════════════
    # NOUVELLES QUESTIONS (liste étendue)
    # ══════════════════════════════════════════════════════════════════════════

    # ── Salutations supplémentaires ────────────────────────────────────────────
    {
        "label": "Salutation — Bonjour !",
        "question": "Bonjour !",
        "expected_intent": "salutation",
        "min_results": 0,
        "min_confidence": 0,
    ...
    {
        "label": "Salutation — HomePedia ?",
        "question": "Salut, c'est quoi HomePedia ?",
        "expected_intent": "salutation",
        "min_results": 0,
        "min_confidence": 0,
        "checks": [_not_empty, _no_sql_leak],
    ...
    {
        "label": "Salutation — Merci à bientôt",
        "question": "Merci, à bientôt",
        "expected_intent": "salutation",
        "min_results": 0,
        "min_confidence": 0,
        "checks": [_not_empty, _no_sql_leak],
    ...
    {
        "label": "Salutation — aide demandée",
    ...
    {
        "label": "Salutation — c'est quoi ce truc",
    ...
    # ── Hors scope supplémentaires ─────────────────────────────────────────────
    {
        "label": "Hors scope — recette pizza",
        "question": "Donne-moi une recette de pizza",
        "expected_intent": "hors_scope",
        "min_results": 0,
        "min_confidence": 80,
        "checks": [_is_hors_scope, _no_sql_leak],
    ...
    {
        "label": "Hors scope — PIB France",
        "question": "C'est quoi le PIB de la France ?",
        "expected_intent": None,
        "min_results": 0,
        "min_confidence": 0,
        "checks": [_not_empty, _no_sql_leak],
    ...
    {
        "label": "Hors scope — Lyon immo",
        "question": "Prix immobilier à Lyon",
        "expected_intent": "hors_scope",
        "min_results": 0,
        "min_confidence": 80,
        "checks": [_is_hors_scope, _no_sql_leak],
    ...
    {
        "label": "Hors scope — Bordeaux maison",
        "question": "Acheter une maison à Bordeaux",
        "expected_intent": "hors_scope",
        "min_results": 0,
        "min_confidence": 80,
        "checks": [_is_hors_scope, _no_sql_leak],
    ...
    {
        "label": "Hors scope — Nice",
        "question": "Immobilier à Nice",
        "expected_intent": "hors_scope",
        "min_results": 0,
        "min_confidence": 80,
        "checks": [_is_hors_scope, _no_sql_leak],
    ...
    {
        "label": "Hors scope — Coupe du Monde",
        "question": "Qui a gagné la Coupe du Monde ?",
        "expected_intent": None,
        "min_results": 0,
        "min_confidence": 0,
        "checks": [_not_empty, _no_sql_leak],
    ...
    {
        "label": "Hors scope — Bitcoin",
        "question": "Cours du Bitcoin aujourd'hui",
        "expected_intent": "hors_scope",
        "min_results": 0,
        "min_confidence": 80,
        "checks": [_is_hors_scope, _no_sql_leak],
    ...
    {
        "label": "Hors scope — restaurant Marseille",
        "question": "Meilleur restaurant à Marseille",
        "expected_intent": "hors_scope",
        "min_results": 0,
        "min_confidence": 80,
        "checks": [_is_hors_scope, _no_sql_leak],
    ...
    # ── General supplémentaires ────────────────────────────────────────────────
    {
        "label": "General — zone tendue",
        "question": "Qu'est-ce que la zone tendue ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "General — prix médian vs moyen",
        "question": "Différence entre prix médian et prix moyen ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "General — loi Pinel",
        "question": "C'est quoi la loi Pinel ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "General — diagnostic énergétique",
        "question": "Comment lire un diagnostic énergétique ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "General — score composite",
        "question": "C'est quoi le score composite ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "General — taux cambriolage ‰",
        "question": "Qu'est-ce que le taux de cambriolage pour mille ?",
        "expected_intent": None,
        "min_results": 0,
        "min_confidence": 0,
        "checks": [_not_empty, _no_sql_leak],
    ...
    # ── KB — Questions théoriques immobilières ─────────────────────────────────
    {
        "label": "KB — DPE définition",
        "question": "C'est quoi exactement le DPE et comment il est noté ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — IPS définition",
        "question": "Qu'est-ce que l'IPS dans le contexte des écoles ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — Rendement brut vs net",
        "question": "Quelle différence entre rendement brut et rendement net ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — Cash flow définition",
        "question": "C'est quoi le cash flow en immobilier locatif ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — Zone tendue",
        "question": "C'est quoi une zone tendue en immobilier ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — Frais de notaire",
        "question": "C'est quoi les frais de notaire quand on achète ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — PTZ primo accédant",
        "question": "Qu'est-ce que le PTZ pour un primo accédant ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — Plus-value immobilière",
        "question": "Comment fonctionne la plus-value immobilière si je revends ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — Grand Paris Express impact",
        "question": "C'est quoi le Grand Paris Express et son impact sur les prix ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — Première vs deuxième couronne",
        "question": "C'est quoi la différence entre première et deuxième couronne ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — Taxe foncière IDF",
        "question": "La taxe foncière varie beaucoup selon les communes IDF ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — LMNP régime fiscal",
        "question": "C'est quoi le statut LMNP et ses avantages ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — hors scope taux crédit",
        "question": "Quel est le taux des crédits immobiliers en ce moment ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — DVF données",
        "question": "C'est quoi le DVF et à quoi ça sert ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "KB — Vacance locative IDF",
        "question": "C'est quoi la vacance locative et est-ce un risque en IDF ?",
        "expected_intent": "general",
        "min_results": 0,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "Prix — Versailles (formel)",
        "question": "Prix au m2 à Versailles ?",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, lambda t: _mentions_commune(t, "Versailles"), _no_sql_leak],
    },
    {
        "label": "Prix — Montreuil (court)",
        "question": "C'est combien à Montreuil ?",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix — Palaiseau (infos)",
        "question": "Donne-moi les infos sur Palaiseau",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix — Cergy",
        "question": "Prix immo Cergy",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, lambda t: _mentions_commune(t, "Cergy"), _no_sql_leak],
    },
    {
        "label": "Prix — Nanterre",
        "question": "C'est quoi le marché à Nanterre stp",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix — Massy",
        "question": "Infos sur Massy",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, lambda t: _mentions_commune(t, "Massy"), _no_sql_leak],
    },
    {
        "label": "Prix — Vincennes",
        "question": "Présente-moi Vincennes",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix — Ivry-sur-Seine",
        "question": "Prix à Ivry-sur-Seine",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix — Clamart",
        "question": "C'est comment à Clamart ?",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix — Argenteuil",
        "question": "Données sur Argenteuil",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, lambda t: _mentions_commune(t, "Argenteuil"), _no_sql_leak],
    },
    {
        "label": "Prix — Rueil-Malmaison",
        "question": "Prix à Rueil-Malmaison stp",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix — Courbevoie",
        "question": "C'est combien le m2 à Courbevoie",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix — Fontenay-sous-Bois",
        "question": "Infos immo sur Fontenay-sous-Bois",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix — Issy-les-Moulineaux",
        "question": "Prix à Issy-les-Moulineaux",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix — Antony",
        "question": "C'est quoi comme marché à Antony ?",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Classement — meilleures villes achat",
        "question": "Meilleures villes pour acheter en banlieue",
        "expected_intent": None,
        "min_results": 3,
        "min_confidence": 0,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Classement — communes famille",
        "question": "Meilleures communes pour une famille",
        "expected_intent": "ecoles_ips",
        "min_results": 3,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Classement — acheter pas cher IDF",
        "question": "Où acheter pour pas cher en IDF ?",
        "expected_intent": None,
        "min_results": 3,
        "min_confidence": 0,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Classement — meilleur score global",
        "question": "Villes avec le meilleur score global",
        "expected_intent": None,
        "min_results": 3,
        "min_confidence": 0,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Classement — qualité de vie",
        "question": "Classement des communes IDF par qualité de vie",
        "expected_intent": "top_qualite_vie",
        "min_results": 3,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Classement — investissement locatif",
        "question": "Les communes avec le meilleur investissement locatif",
        "expected_intent": None,
        "min_results": 3,
        "min_confidence": 0,
        "checks": [_has_numbers, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Rendement — ratio loyer/prix",
        "question": "Communes avec le meilleur ratio loyer/prix",
        "expected_intent": "rendement",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_has_numbers, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Rendement — meilleur cash flow",
        "question": "Meilleur cash flow en IDF",
        "expected_intent": "rendement",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_has_numbers, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Rendement — rentabilité brute max",
        "question": "Rentabilité locative brute la plus élevée",
        "expected_intent": "rendement",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_rendement_realistic, _no_sql_leak],
    },
    {
        "label": "Rendement — loyer vs prix",
        "question": "Où le loyer ramené au prix est le plus intéressant ?",
        "expected_intent": "rendement",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_has_numbers, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Rendement — fort rendement banlieue",
        "question": "Communes avec fort rendement en banlieue parisienne",
        "expected_intent": "rendement",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_has_numbers, _no_sql_leak, _mentions_idf_commune],
    ...
    # ── DPE supplémentaires ────────────────────────────────────────────────────
    {
        "label": "DPE — moins d'énergie",
        "question": "Où les logements consomment le moins d'énergie ?",
        "expected_intent": "dpe",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "DPE — performance énergétique IDF",
        "question": "Meilleure performance énergétique en IDF",
        "expected_intent": "dpe",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "DPE — classe A ou B",
        "question": "Communes classées A ou B en énergie",
        "expected_intent": "dpe",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "DPE — passoires thermiques",
        "question": "Éviter les passoires thermiques — où chercher ?",
        "expected_intent": "dpe",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "DPE — communes écologiques IDF",
        "question": "Communes écologiques en Île-de-France",
        "expected_intent": "dpe",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Sécurité — peu de cambriolages",
        "question": "Où il y a peu de cambriolages en banlieue ?",
        "expected_intent": "securite",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Sécurité — calmes et tranquilles",
        "question": "Communes calmes et tranquilles",
        "expected_intent": "securite",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Sécurité — faible criminalité",
        "question": "Faible criminalité en Île-de-France",
        "expected_intent": "securite",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Sécurité — famille sécurisée",
        "question": "Où se sentir en sécurité avec sa famille ?",
        "expected_intent": None,
        "min_results": 1,
        "min_confidence": 0,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Sécurité — peu de délinquance",
        "question": "Communes avec peu de délinquance",
        "expected_intent": "securite",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    # ── Écoles / IPS supplémentaires ───────────────────────────────────────────
    {
        "label": "Écoles — meilleures écoles",
        "question": "Communes avec les meilleures écoles",
        "expected_intent": "ecoles_ips",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Écoles — bien scolarisés",
        "question": "Où les enfants sont bien scolarisés en IDF ?",
        "expected_intent": "ecoles_ips",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Écoles — bon IPS",
        "question": "Communes avec bon IPS",
        "expected_intent": "ecoles_ips",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_has_numbers, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Écoles — familles avec enfants",
        "question": "Meilleures communes pour les familles avec enfants",
        "expected_intent": "ecoles_ips",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Écoles — favorisées en banlieue",
        "question": "Écoles favorisées en banlieue",
        "expected_intent": "ecoles_ips",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_has_numbers, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Écoles — envoyer enfants IDF",
        "question": "Où envoyer mes enfants à l'école en IDF ?",
        "expected_intent": "ecoles_ips",
        "min_results": 3,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Comparaison — Versailles vs Vincennes",
        "question": "Compare Versailles et Vincennes",
        "expected_intent": "comparaison",
        "min_results": 2,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Comparaison — Massy ou Palaiseau",
        "question": "Massy ou Palaiseau, lequel est mieux ?",
        "expected_intent": "comparaison",
        "min_results": 2,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Comparaison — Montreuil vs Pantin",
        "question": "Différence entre Montreuil et Pantin",
        "expected_intent": "comparaison",
        "min_results": 2,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Comparaison — Issy vs Clamart",
        "question": "Compare Issy-les-Moulineaux et Clamart",
        "expected_intent": "comparaison",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Comparaison — Pontoise vs Cergy",
        "question": "Pontoise vs Cergy",
        "expected_intent": "comparaison",
        "min_results": 2,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Comparaison — Nanterre ou Colombes",
        "question": "Nanterre ou Colombes pour investir ?",
        "expected_intent": "comparaison",
        "min_results": 2,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Comparaison — Arcueil ou Cachan",
        "question": "Arcueil ou Cachan, lequel est moins cher ?",
        "expected_intent": "comparaison",
        "min_results": 2,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Comparaison — Argenteuil vs Asnières",
        "question": "Compare Argenteuil et Asnières",
        "expected_intent": "comparaison",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Comparaison — Neuilly vs Boulogne",
        "question": "Neuilly-sur-Seine ou Boulogne-Billancourt ?",
        "expected_intent": "comparaison",
        "min_results": 0,
        "min_confidence": 60,
        "checks": [_not_empty, _no_sql_leak],
    ...
    # ── Département supplémentaires ────────────────────────────────────────────
    {
        "label": "Département — 92 Hauts-de-Seine",
        "question": "Meilleures communes du 92",
        "expected_intent": "departement",
        "min_results": 3,
        "min_confidence": 50,
        "checks": [_has_numbers, _no_sql_leak],
    ...
    {
        "label": "Département — Seine-et-Marne",
        "question": "Seine-et-Marne immobilier",
        "expected_intent": "departement",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_has_numbers, _no_sql_leak],
    ...
    {
        "label": "Département — meilleures du 93",
        "question": "Les meilleures communes du 93",
        "expected_intent": "departement",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak],
    ...
    {
        "label": "Département — Yvelines",
        "question": "Yvelines, où acheter ?",
        "expected_intent": "departement",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_has_numbers, _no_sql_leak],
    ...
    {
        "label": "Département — Val-d'Oise",
        "question": "Val-d'Oise pas cher",
        "expected_intent": "departement",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_has_numbers, _no_sql_leak],
    ...
    {
        "label": "Département — 91 bon rendement",
        "question": "Communes du 91 avec bon rendement",
        "expected_intent": "departement",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_has_numbers, _no_sql_leak],
    ...
    # ── Prix max supplémentaires ───────────────────────────────────────────────
    {
        "label": "Prix max — sous 3000 €/m²",
        "question": "Communes avec prix sous 3000 € le m2",
        "expected_intent": "prix_max",
        "min_results": 3,
        "min_confidence": 50,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix max — moins de 4000 €/m²",
        "question": "Moins de 4000 € le m2 en IDF",
        "expected_intent": "prix_max",
        "min_results": 3,
        "min_confidence": 50,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix max — budget 2500 €/m²",
        "question": "Budget 2500 €/m2 où acheter ?",
        "expected_intent": "prix_max",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_has_numbers, _no_sql_leak],
    ...
    {
        "label": "Prix max — accessible 3500 €/m²",
        "question": "Immobilier accessible sous 3500 €/m2",
        "expected_intent": "prix_max",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix max — moins de 5000 €/m²",
        "question": "Je cherche moins de 5000 € le m2",
        "expected_intent": "prix_max",
        "min_results": 3,
        "min_confidence": 50,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Prix max — sous 4000 banlieue",
        "question": "Pas cher en banlieue, sous 4000 euros le mètre",
        "expected_intent": "prix_max",
        "min_results": 3,
        "min_confidence": 50,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    # ── Multi-critères supplémentaires ─────────────────────────────────────────
    {
        "label": "Multi-critères — sûre + DPE + prix",
        "question": "Commune sûre avec bon DPE et prix raisonnable",
        "expected_intent": "multi_criteria",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "Multi-critères — calme + pas cher",
        "question": "Endroit calme et pas cher",
        "expected_intent": "multi_criteria",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak],
    ...
    {
        "label": "Multi-critères — famille + criminalité",
        "question": "Commune familiale avec faible criminalité",
        "expected_intent": "multi_criteria",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "Multi-critères — pas cher + sûr + DPE",
        "question": "Pas cher, sûr et avec bon DPE",
        "expected_intent": "multi_criteria",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _no_generic_error],
    ...
    {
        "label": "Multi-critères — budget + écoles qualité",
        "question": "Budget 4000 € avec écoles de qualité",
        "expected_intent": "multi_criteria",
        "min_results": 1,
        "min_confidence": 50,
        "checks": [_has_numbers, _no_sql_leak],
    ...
    # ── Formulations décontractées / argot ─────────────────────────────────────
    {
        "label": "Argot — c koi prix versailles",
        "question": "c koi le prix à versailles",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Argot — prix immo montreuil stp",
        "question": "stp donne les prix immo montreuil",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Argot — investir grave bien",
        "question": "où investir grave bien en idf ?",
        "expected_intent": "top_investissement",
        "min_results": 3,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Argot — coin sympa banlieue",
        "question": "quel coin sympa pour vivre en banlieue ?",
        "expected_intent": "top_qualite_vie",
        "min_results": 3,
        "min_confidence": 50,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
    ...
    {
        "label": "Argot — les plus chères",
        "question": "les plus cheres c'est ou ?",
        "expected_intent": "top_prix",
        "min_results": 3,
        "min_confidence": 50,
        "checks": [_has_numbers, _has_valid_prix_idf, _no_sql_leak],
    ...
    {
        "label": "Argot — marché cergy",
        "question": "c'est nul le marché à cergy ou c'est bon ?",
        "expected_intent": "commune_detail",
        "min_results": 1,
        "min_confidence": 60,
        "checks": [_has_numbers, _has_valid_prix_idf, lambda t: _mentions_commune(t, "Cergy"), _no_sql_leak],
    ...
    {
        "label": "Argot — conseiller ville",
        "question": "vous conseillez quoi comme ville ?",
        "expected_intent": None,
        "min_results": 3,
        "min_confidence": 0,
        "checks": [_not_empty, _no_sql_leak, _mentions_idf_commune],
